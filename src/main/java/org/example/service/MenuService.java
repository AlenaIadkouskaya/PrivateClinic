...
public class MenuService {
    public static void printMainMenu() {
        ...
        System.out.println("Enter   2   for Registration New Patient");
    ...
    public static void printDoctorMenu(User user) {
        ...
        System.out.println("Doctor: " + user.getName() + " " + user.getSurname());
        System.out.println("Choose your options:");
    ...
    public static void printPatientMenu(User user) {
        ...
        System.out.println("Patient: " + user.getName() + " " + user.getSurname());
        System.out.println("Choose your options:");
        System.out.println("Enter   1   for Show Visit");
